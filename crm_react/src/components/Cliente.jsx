...
export async function action({params}){
	await eliminarCliente(params.client_id)
	return redirect('/')
}
...
function Cliente({cliente}){
	...
	return (
			...
			<tr className="border-b">
				...
				<td className="p-6">
					<p className="text-gray-600"><span className="text-gray-800 uppercase font-bold">Email: {email}</span></p>
					<p className="text-gray-600"><span className="text-gray-800 uppercase font-bold">Teléfono: {telefono}</span></p>
				</td>
